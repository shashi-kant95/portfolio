...
maintained."
        details={<div>In this project, we develop a platform where all the internal project details/status are
          ...
          <b>Language used:</b> REACT JS, .NET, MYSQL</div>} />
        ...
        details={<div>This is Unilever Project, where they can simulate, compare, forecast the investment and
...
brands and also implemented sso login using Msal react library.<br />
          <b>Language used:</b> REACT JS, .NET CORE, MYSQL, PYTHON</div>} />


          <Card pno='03'
        preview="This is Unilever Project, where they can optimize the future expenses in different ways."
        details={<div>This is Unilever Project, where they can optimize the future expenses in different ways.<br />
...
sso login to avoid testing issues.<br />
          <b>Language used:</b> REACT JS, .NET, MYSQL, PYTHON
</div>} />
        ...
        details={<div>This is Unilever Project, where we have survey data and we are showing users those data in 
...
different type of chart.<br />
          <b>Language used:</b> JAVASCRIPT, JQUERY .NET CORE 6, MYSQL, PYTHON</div>} />
    </div>
  )
}
